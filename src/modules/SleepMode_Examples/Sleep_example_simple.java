...
//            Atlantica04 Entering: 6s -> 115w
	...
	// Host 1
                ...
                cloudletList.add(createCloudlet(user_id, 30000));
                vmList.add(createVm(user_id, 1800 + time_next));
                cloudletList.add(createCloudlet(user_id, 66000));
                vmList.add(createVm(user_id, 3120 + time_next));
                cloudletList.add(createCloudlet(user_id, 144000));
	...
	// Host 10
                ...
                cloudletList.add(createCloudlet(user_id, 120000));
