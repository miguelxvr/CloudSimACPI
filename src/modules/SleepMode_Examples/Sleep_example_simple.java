...
public class Sleep_example_simple {
    ...
    private static int cloudletsNumber = 2;
    private static int hostsNumber = 4;
    private static int vmsNumber = 2;

    private static int vmsStartlNumber = 0;
    private static int no_cur_vm = 0;

    private static int cloudletsStartNumber = 2;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cloudletList = createCloudletList(user_id, 1, 0);
            ...
            Runnable monitor = new Runnable() {
                ...
                int insertTimes[] = {300, 600, 900};

                @Override
                public void run() {
                    int i = 0;
                    while (i < insertTimes.length) {
                        CloudSim.pauseSimulation(insertTimes[i]);
                        while (true) {
                            if (CloudSim.isPaused()) {
                                ...
                                cloudletList = createCloudletList(brokerId, 1, 100); // creating 1 cloudlets
