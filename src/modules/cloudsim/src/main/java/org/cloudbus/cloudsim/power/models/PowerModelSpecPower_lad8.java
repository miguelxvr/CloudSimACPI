 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad8 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_idle[] = {90, 94, 100, 104, 107, 30};
        double Tab_Power_full[] = {170, 176, 182, 188, 193, 92};
        List<Pe> peList;

        Pe tmp_pe;
           
       
    public PowerModelSpecPower_lad8(List<Pe> PeList_) {
        peList = PeList_;
