 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad6 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_idle[] = {90, 94, 100, 104, 107, 31};
    ...
    public PowerModelSpecPower_lad6(List<Pe> PeList_) {
        peList = PeList_;
