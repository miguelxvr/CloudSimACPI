 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad5 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_full[] = {170, 176, 182, 188, 193, 95};
        List<Pe> peList;

        Pe tmp_pe;
           
       
    public PowerModelSpecPower_lad5(List<Pe> PeList_) {
        peList = PeList_;
