 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad9 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_idle[] = {90, 94, 100, 104, 107, 35};
        double Tab_Power_full[] = {170, 176, 182, 188, 193, 74};
        List<Pe> peList;

        Pe tmp_pe;
           
       
    public PowerModelSpecPower_lad9(List<Pe> PeList_) {
        peList = PeList_;
