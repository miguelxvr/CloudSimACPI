 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad2 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_idle[] = {90, 94, 100, 104, 107, 36};
        double Tab_Power_full[] = {170, 176, 182, 188, 193, 78};
        List<Pe> peList;

        Pe tmp_pe;
           
       
    public PowerModelSpecPower_lad2(List<Pe> PeList_) {
        peList = PeList_;
