 ...
 * @author miguel
 */
public class PowerModelSpecPower_lad7 extends PowerModelSpecPowerDVFS {
        ...
        double Tab_Power_idle[] = {90, 94, 100, 104, 107, 28};
        double Tab_Power_full[] = {170, 176, 182, 188, 193, 90};
        List<Pe> peList;

        Pe tmp_pe;
           
       
    public PowerModelSpecPower_lad7(List<Pe> PeList_) {
        peList = PeList_;
